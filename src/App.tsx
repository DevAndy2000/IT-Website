        ...
        <nav className="flex justify-between items-center px-8 max-w-7xl mx-auto">
          <div className="flex items-center">
            <a href="/" className="text-2xl font-bold text-gray-900 hover:text-teal-400 transition-all">
              {/* Correct logo path */}
              <img src="/IT-Website/assets/logo.png" alt="StaffinITy Solutions Logo" className="h-24" />
            </a>
          </div>
      ...
      <section id="why-choose-us" className="py-20 px-6 bg-white text-center pt-28">
        ...
        <div className="max-w-3xl mx-auto text-left">
          <ul className="space-y-4">
            ...
            <li className="flex items-center">
              <span className="mr-4 text-teal-600">✔</span> Trusted Partnerships - Your success is our mission. We build long-term relationships based on trust and results.
            </li>
          </ul>
        </div>
      </section>
